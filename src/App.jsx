              ...
              <div>
                {!selDoc?(
                  <>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl px-3.5 py-2.5 mb-4 flex gap-2 items-start"><span className="text-sm flex-shrink-0">💡</span><p className="text-xs text-amber-700 leading-relaxed"><b>현재 임시 저장</b> — 새로고침 시 초기화. Supabase 무료 플랜 연동 시 1GB 영구 저장.</p></div>
